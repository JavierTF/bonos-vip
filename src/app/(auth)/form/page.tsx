          ...
          <form onSubmit={handleLoginSubmit(onLogin)} className="space-y-4">
            <div>
              ...
              <input 
                ...
                type="email"
                className={`w-full border rounded-md p-2 ${loginErrors.email ? 'border-red-500' : ''}`}
              />
              {loginErrors.email && (
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className={`w-full border rounded-md p-2 pr-10 ${loginErrors.password ? 'border-red-500' : ''}`}
                />
                <button
                  type="button"
          ...
          <form onSubmit={handleRegisterSubmit(onRegister)} className="space-y-4">
            <div>
              ...
              <input 
                ...
                type="email"
                className={`w-full border rounded-md p-2 ${registerErrors.email ? 'border-red-500' : ''}`}
              />
